...
export const Route = createFileRoute("/authors/$slug")({
  ...
  errorComponent: ({ error }) => <SiteLayout><div className="p-12 text-sm text-destructive">{error.message}</div></SiteLayout>,
  notFoundComponent: () => (
    <SiteLayout>
    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
          {author.avatar_url ? (
            <img src={author.avatar_url} alt="" className="h-16 w-16 rounded-full object-cover ring-1 ring-border" />
          ) : (
