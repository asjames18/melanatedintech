...
const navGroups: NavGroup[] = [
    ...
    items: [
      {
        label: "All Systems",
        to: "/systems",
        description: "Revenue recovery, estimate follow-up, and retention",
      },
      {
        label: "Revenue Diagnostic",
        to: "/diagnostic",
        description: "Paid diagnostic for one revenue leak",
      },
      {
      ...
      },
      {
        ...
        to: "/systems/estimate-recovery",
        description: "Follow-up for quotes that never closed",
      },
      {
        label: "Route & Retention",
        to: "/systems/route-retention",
        description: "Keep recurring property-service density",
      },
      {
        label: "Client Recovery",
        to: "/systems/client-recovery",
        description: "Win back stalled or silent accounts",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "AI Radar & Updates",
        to: "/radar",
        description: "Live intelligence on models, agents, and tooling",
      },
      {
      ...
      },
      {
        label: "Marketplace",
        to: "/agents",
        description: "Production-ready agents for real workflows",
      },
      {
        label: "Starter Packs",
        to: "/starter-packs",
      ...
      },
      {
        label: "Roadmap",
        to: "/roadmap",
        description: "What is shipping next on the platform",
      },
    ],
  },
];
    ...
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/85">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-0.5 xl:gap-1.5 lg:flex" aria-label="Primary navigation">
          ...
          {/* Systems (existing revenue-recovery destinations) */}
          <div className="group relative">
            <Link
              to="/systems"
              className="whitespace-nowrap shrink-0 flex items-center gap-1 rounded-lg px-2 xl:px-3 py-2 text-xs xl:text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground group-hover:text-foreground"
      ...
      {open && (
        ...
        >
          <div className="space-y-4">
            ...
            {/* Direct Links: Case Studies, Marketplace, About, Contact */}
