-- Fix malformed Markdown in the existing Knowledge Hub article
-- human-approval-patterns-for-agents: space the H1 hash, and restore the
-- Scorecard heading plus table. Article copy is otherwise unchanged from
-- 20260702180000_expand_all_hub_articles.sql.
