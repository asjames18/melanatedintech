...
export function AiLeadModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!consent) {
      setFormError("Please confirm we may contact you about this request.");
      return;
    }
        ...
        {submittedResult ? (
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-3.5">
              ...
              <label className="flex cursor-pointer gap-3 rounded-2xl border border-border bg-muted/30 p-3 text-xs leading-relaxed">
                <input
                  required
                  id="lead-consent"
                  type="checkbox"
